...
function updateDepth(book, newPage) {
  ...
  else $(".sj-book .p111 .depth").css({ width: 0 });
}

function loadPage(page) {
  $.ajax({
    url: "src/turnjs/samples/steve-jobs/pages/page" + page + ".html"
...
function zoomHandle(e) {
  if ($(".sj-book").data().zoomIn) zoomOut();
...
export default { isChrome, zoomHandle };
